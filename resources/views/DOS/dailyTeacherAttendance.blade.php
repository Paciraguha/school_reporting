    ...
    function getStudentReportData() {
       ...
       // let  fromDate=document.getElementById("fromDate").value;
        ...
        let  toDate=document.getElementById("toDate").value;
         ...
         const schoolTeacherAttendance = `/api/schoolTeacherAttendance`
            ...
            success: function(response) {
                ...
                data.forEach((response) => {
                    ...
                    if (response.levels == 'Nusery') {
                        const attendance = response.TeachersAttendance
                        ...
                        if (attendance.length < 1) {
                            ...
                            <tr>
                                <td class="px-2 py-2 border border-b-2 border-slate-300">${a}</td>
                                 <td class="px-2 py-2 border border-b-2 border-slate-300 "><a class="cursor-pointer text-red-600" href='/SectorAttendanceReportByDate/${sectorCode}?date=${element.attendedDay}'>${element.attendedDay}</a></td>
