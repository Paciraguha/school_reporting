...
<div class="flex flex-col p-4">
    ...
    <div class="flex gap-4">
        <div class="flex flex-col rounded-md shadow-lg p-4 w-1/2">
            <h3 class="py-2  my-4 w-full  font-extralight text-[20px]" id="table-title">
                {{ __("Students Attendance Detail in nusery") }}
            </h3>
        ...
        <div class="flex flex-col rounded-md shadow-lg p-4 w-1/2">
            <h3 class="py-2  my-4 w-full  font-extralight text-[20px]">
                {{ __("Students Attendance Detail in Primary") }}
            </h3>
    ...
    <div class="flex gap-4 mt-6">
        <div class="flex flex-col rounded-md shadow-lg p-4 w-1/2">
            <h3 class="py-2  my-4 w-full  font-extralight text-[20px]">
                {{ __("Students Attendance Detail in Secondary") }}
            </h3>
        ...
        <div class="flex flex-col rounded-md shadow-lg p-4 w-1/2">
            <h3 class="py-2  my-4 w-full  font-extralight text-[20px]">
                {{ __("Students Attendance Detail in TVET ") }}
            </h3>
...
function removeAllRows() {
    ...
    function getStudentReportData() {
       ...
       // let  fromDate=document.getElementById("fromDate").value;
        ...
        const studentAttendanceBySector = `/api/DEO_SectorAttendanceBySector/${sectorCode}`;
                    ...
                    if (response.levels == 'Nusery') {
                        ...
                        if (attendance.length < 1) {
                            ...
                            <tr>
                                ...
                                <td class="px-2 py-2 border border-b-2 border-slate-300">${element.SchoolName}</td>
