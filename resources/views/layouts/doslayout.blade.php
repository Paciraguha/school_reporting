    ...
    if(user.position ==='DOS'){
        document.getElementById('sidebar-multi-level-sidebar').innerHTML=`
            ...
            <div class="max-w-lg mx-auto  rounded-lg border border-blue-300 py-2">
                ...
                <p class="text-center text-gray-600 mt-1" id="position">DOS</p>
            </div>
            <ul class="space-y-2 font-medium mt-5">
                ...
                <li>
                    <a href="{{route('teacherNewAttendance')}}"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg class="flex-shrink-0 w-5 h-5 text-gray-400 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 20 18">
...
// head teacher section-----------------------------------------------------------------------------------------------------------------------
        if(user.position ==='HeadTeacher'){
            ...
            <ul class="space-y-2 font-medium mt-5">
                ...
                <li>
                    <a href="{{route('assignClassToTeacher')}}"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg class="flex-shrink-0 w-5 h-5 text-gray-400 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 20 18">
